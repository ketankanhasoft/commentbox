...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 form_hideshow" style="display: none;">
            <form role="form" id="addcomment" method="POST" action="{{ route('comment.store')}}" enctype="multipart/form-data">   
            @csrf
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="add_replies_{{$comm->id}} " style="display: none;">
                                        <form role="form" id="addcomment_{{$comm->id}}" method="POST" action="{{ route('comment.replies',$comm->id)}}" enctype="multipart/form-data">   
                                            @csrf
                                            <div class="form-group {{ $errors->has('comment') ? 'has-error' : '' }}">
                                                <label>Comment:</label>
                                                <textarea class="form-control" id="comment" name="comment"></textarea>
